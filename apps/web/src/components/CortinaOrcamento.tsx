...
export function CortinaOrcamento({
  ...
  embutido = false, onEstado, onCarregar, permitirInstalacao = true, descontoPct = 0,
}: {
  ...
  /** % de desconto da revenda (0 p/ vendedor/admin) — repassado ao badge minimizado do card. */
  descontoPct?: number;
}) {
