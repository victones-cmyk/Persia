// apps/api/src/services/calc/divisaoFolhas.ts
...
//
// Espelhado em apps/web/src/lib/divisaoFolhas.ts, que é quem realmente usa hoje
// (a divisão acontece ao montar o orçamento). A cópia canônica e testada mora
// aqui, no mesmo espírito de roundHalfUp.
