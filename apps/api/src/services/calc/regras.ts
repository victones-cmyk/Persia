...
export function normalizar(input: unknown): RegrasCalculo {
  ...
  return {
    persiana: {
      ...
      parafuso_passo: num(p.parafuso_passo, d.persiana.parafuso_passo) || d.persiana.parafuso_passo,
    ...
    cortina: {
      ...
      passo_tecido: num(c.passo_tecido, d.cortina.passo_tecido) || d.cortina.passo_tecido,
      passo_botao_wave: num(c.passo_botao_wave, d.cortina.passo_botao_wave) || d.cortina.passo_botao_wave,
      ...
      espacamento_ilhos_default: num(c.espacamento_ilhos_default, d.cortina.espacamento_ilhos_default) || d.cortina.espacamento_ilhos_default,
      espacamento_ferragem_default: num(c.espacamento_ferragem_default, d.cortina.espacamento_ferragem_default) || d.cortina.espacamento_ferragem_default,
