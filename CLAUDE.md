...
- BLOQUEANTE-07: "Cortina simples + adicionar tecido" (Victor 23/06/2026, substitui o antigo #6 "modelo de tecido por camada"). Victor quer que o sistema sempre calcule uma cortina simples e ele possa adicionar tecido. Mecânica indefinida — ele ofereceu CALL para explicar. PENDENTE da call (definir cálculo + UI + envio ao GC).
