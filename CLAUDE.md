...
- EM ABERTO (v.4.1, dependem do Victor): (A) franzido > 3× "joga o cálculo muito acima" na cortina COM EMENDA — precisa do caso exato (medidas+franzido+valor esperado); (C) persiana: Victor diz que componentes "têm custo" — decidir se entram no preço (hoje RN-03 = só tecido); fixação por camada (ver BLOQUEANTE-07).
